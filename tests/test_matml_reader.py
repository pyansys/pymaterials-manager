...
class TestMatmlReader:
    ...
    def test_reader(self):
        ...
        assert steel[rho].parameters["Options Variable"].qualifiers["AlgorithmType"] == "Linear Multivariate (Qhull)"
        assert steel[rho].parameters['Temperature'].qualifiers['Lower Limit'] == "Program Controlled"
        ...
        assert e_glass_ud[elast].parameters["Poisson's Ratio XY"].qualifiers['Variable Type'] == "Dependent"
        ...
        assert e_glass_ud[elast].parameters["Shear Modulus YZ"].qualifiers['Variable Type'] == "Dependent"
