...
class Material:
    """
    Wrapper class for a material. Associates a material_id with one or more properties and nonlinear material
    models.
    """
    ...
    def __init__(
        ...
        properties: Union[MaterialPropertyDict, Dict]
            ...
            either a float value or a np.ndarray of temperatures and property values. Nonlinear material models are
